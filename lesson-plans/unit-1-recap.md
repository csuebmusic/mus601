...
Orlando di Lasso (1532–1594) finished the *Lagrime di San Pietro* at the end of his life, a decade before the controversy over Monteverdi's seconda pratica. Its twenty religious madrigals and closing Latin motet are meant to be performed in succession, since the cycle has a theme and a progression. The first twelve deal with Peter's denial of Christ, seen through the eyes of the poet. Madrigals thirteen to twenty are seen mainly through Peter's eyes: realizing his error and distraught with grief, he flees Christ's presence and rages at his own existence. The last piece is a plaint of Christ on the cross. Unlike the first twenty, which are in Italian, its text is in Latin, and it may be by Lasso himself.

The *Lagrime* was printed in Munich in 1595 for seven voices, on stanzas by Luigi Tansillo.

The madrigals are grouped by mode: 1–4 in mode I, 5–8 in mode II, 9–12 in modes III and IV, 13–15 in mode V, 16–18 in mode VI, 19–20 in mode VII, and the closing motet outside the eight church modes. Powers's tonal plan of the cycle matches the modal grouping above. Nos. 1–4 are in the ♮ system with final D, representing mode 1, and nos. 5–8 are in the ♭ system with final G, representing mode 2. In both groups the third madrigal closes a fifth above the principal final. Powers reads the modal ordering of pious cycles like this one as an expression of Counter-Reformation lay piety (Powers, 446–48). "Il magnanimo Pietro" opens the mode 1 group.

No. I is where Powers and Burnett and Nitzberg meet on one observation: ♮-c1-D for Powers, naturalis for Burnett and Nitzberg. Powers describes what marks a piece from outside (system, cleffing, final); Burnett and Nitzberg claim what governs its chromatic behavior from inside, and the two disagree on whether the hexachordal system is the operative background.
...
Alto, tenor, bass, and continuo; cantus durus; center A. Three half notes to the measure.

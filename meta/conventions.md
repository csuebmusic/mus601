...
- `meta/bibliography-scaffold.md`: Peter's scaffold, canonical for the research and bibliography arc. The per-paper source task, tool sequencing, trustworthiness lens, and scaffolding level come from here. Where it and an earlier conversation disagree, it wins.

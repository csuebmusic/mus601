...
- `tools/`: interactive analytical tools and handouts. `tools/modal-species.html` gives the four categories of mode with the species of fourth and fifth and the authentic and plagal ambitus. `tools/gamut-layers.html` lays the hexachordal, tetrachordal, and modal divisions over one pitch field as eleventh-century scalar and modal theory. `tools/affinities.html` gives the affinities, the cofinals, and transposition.
